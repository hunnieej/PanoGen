...
erp_path = "./outputs/test/sana_grass_v2/final.png"  # equirectangular panorama (W=4096, H=512 typically)
...
html_path = "./outputs/test/sana_grass_v2/erp_sphere_interactive.html"
